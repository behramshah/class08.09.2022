...
let priceButton = document.getElementById('showPrice');
...
let getPrice = function (e) {
  const idItem = e.target.innerHTML
  const filtered = products.filter( product => product.id === idItem)
  console.log(e.target)
}

selectProducts.addEventListener('change', getPrice);

products.forEach(item => createOption(item));
